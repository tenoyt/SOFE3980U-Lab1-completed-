...
public class BinaryTest 
{
    ...
    @Test
    public void or3(){
        Binary binary1=new Binary("111001");
        Binary binary2=new Binary("100101");
        Binary binary3=Binary.or(binary1,binary2);
        assertEquals("111101", binary3.getValue());
    }
    @Test
    public void and1(){
        Binary binary1=new Binary("111001");
        ...
        assertEquals("100001", binary3.getValue());
    }
    @Test
    public void and2(){
        Binary binary1=new Binary("0");
    ...
    public void multiply2(){
        ...
        Binary binary3=Binary.multiply(binary1,binary2);
        assertEquals("10001100", binary3.getValue());
    }
    @Test
    public void multiply3(){
        Binary binary1=new Binary("100110");
        Binary binary2=new Binary("101001");
        Binary binary3=Binary.multiply(binary1,binary2);
        assertEquals("11000010110", binary3.getValue());
    }
}
